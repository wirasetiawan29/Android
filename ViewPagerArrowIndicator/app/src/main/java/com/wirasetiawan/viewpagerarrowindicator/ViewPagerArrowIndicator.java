...
public class ViewPagerArrowIndicator extends LinearLayout {
    ...
    private void init(Context context) {
        ...
        setArrowIndicatorRes(com.wirasetiawan.viewpagerarrowindicator.R.drawable.ic_arrow_left,
                com.wirasetiawan.viewpagerarrowindicator.R.drawable.ic_arrow_right);
